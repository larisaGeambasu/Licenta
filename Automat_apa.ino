...
void setup() {
  pinMode(A1,INPUT); // pinul de la senzorul de apa il setez ca input
...
void loop() {
  a = analogRead(A1); // variabila care retine valoarea convertita a semnalului de tensiune transmis de catre senzor
